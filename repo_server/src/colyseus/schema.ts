...
export class CodeGridsGrid extends Schema {
    ...
    constructor(grid: CodeGrid & { owner?: string, visitors?: string[] }) {
        super();
        ...
        this.visitors = new ArraySchema<string>(...(grid.visitors ?? []));
...
export class CustomAssetsItem extends Schema {
    @type("string") id: string;
    @type("string") optionId: string;
    @type("string") name: string = "";
...
export class GimkitState extends Schema {
    ...
    @type({ map: CustomAssetsItem }) customAssets = new MapSchema<CustomAssetsItem>();
