...
export default class Player {
    ...
    init() {
        ...
        this.player.permissions.adding = true;
        this.player.permissions.removing = true;
        this.player.permissions.editing = true;
        this.player.permissions.manageCodeGrids = true;
